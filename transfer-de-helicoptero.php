...
<!-- Title -->
	<title>Executive Car SP | Transfer de Helicóptero</title>
...
<body>
	...
	<div class="outer-wrapper">
		...
		<div id="page-header">
			<h1>Transfer de Helicóptero</h1>
			<div class="title-block3"></div>
			<p><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Transfer de Helicóptero</p>
		</div>
			...
			<div class="main-content main-content-full">
				...
				<div class="clearfix">
					...
					<div class="qns-one-half">
						...
						<h4>Transfer de Helicóptero</h4>
						<div class="title-block7"></div>
					
				
                        <p>Em vez da estrada, quem sabe o céu? Um transporte diferenciado para pessoas exclusivas que buscam agilidade e um atendimento único.
                        
                        <p><strong>A Executive Car SP</strong>  oferece para você o Transfer Aéreo partindo de diversas localidades do Brasil.
					...
					<div class="qns-one-half qns-last">
						...
						<div class="photo-gallery-wrapper photo-gallery-1-col clearfix">
							...
							<div class="photo-gallery-item"><a href="images/transfer-de-helicoptero.jpg" data-gal="prettyPhoto"><img src="images/transfer-de-helicoptero.jpg" alt="" /></a></div>
				...
				<ul class="link-blocks clearfix">
					...
					<li><h3><a href="contato.php" class="link-block-2"><span class="link-text">Fale Conosco</span><span class="link-arrow fa fa-angle-right"></span></a></h3></li>
				</ul>
