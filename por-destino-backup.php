 ...
 <!-- fim  ==========================================-->	                            
                       ...
                       <!-- 1 -->	
                        <div class="vehicle-section clearfix">
							...
							<img src="images/image63.jpg" alt="" /> <br>
                            </div>
							 <!-- 1 -->		
                        ...
                        <div class="vehicle-section clearfix">
							...
							<img src="images/kia-carnival-small.jpg"/> <br>
							 ...
							 <!-- 7 -->	
                                                ...
                                                <!-- 8 -->	
                        <div class="vehicle-section clearfix">
									<p><strong><input type="radio" name="veiculo" value='Van de 15 Lugares'  <?PHP print $fisica; ?>>Van de 15 Lugares</strong>Mercedes Sprinter, Renault Master ou Similar</p>
							<ul>
                ...
                <!-- 11 -->	
                        <div class="vehicle-section clearfix">
							...
							<textarea name="comentarios" cols="10" rows="14"></textarea>	
