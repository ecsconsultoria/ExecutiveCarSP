...
$sess_duracao = $_REQUEST['sess_duracao'];
...
$envia = mail($para,utf8_decode("Cotação Transporte Executivo - Diária"),utf8_decode($mensagem),$headers);
...
<!-- Title -->
	<title>Executive Car SP | Por Hora 2</title>
	...
	<div class="outer-wrapper">
	 ...
	 <?php include("menu.php"); ?>
			...
			<div class="main-content main-content-full">
				...
				<div class="booking-step-wrapper clearfix">
					...
					<div class="step-wrapper clearfix">
						...
						<div class="step-title">Origem, data e hora</div>
					</div>
				...
				<div class="full-booking-wrapper full-booking-wrapper-3 clearfix">
					...
					<h4>Detalhes do Serviço e Veículo</h4>
					<div class="title-block7"></div>
                    
                    <!-- BEGIN .contact-form-1 -->
						<form action="por-hora-2.php" class="contact-form-1" method="post">
					...
					<div class="clearfix">
						...
						<p class="clearfix"><strong>Tipo:</strong> <span>Cotação por Hora</span></p>
							...
							<p class="clearfix"><strong>Duração:</strong> <span><?   echo $sess_duracao; ?><input type="hidden" name="sess_duracao" value="<? echo $sess_duracao; ?>" /></span></p>
		...
		<p><strong>Hora de Saída:</strong> <?   echo $sess_hr; ?>
                            ...
                            <a href="recalcular.php.php" class="view-map-button">Recalcular rota</a>
