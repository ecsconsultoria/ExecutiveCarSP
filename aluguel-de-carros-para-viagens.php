...
<!-- Title -->
	<title>Executive Car SP | Aluguel de Carros para Viagens</title>
...
<body>
	...
	<div class="outer-wrapper">
		...
		<div id="page-header">
			...
			<p><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Aluguel de carros para viagens</p>
		</div>
			...
			<div class="main-content main-content-full">
				...
				<div class="clearfix">
					...
					<div class="qns-one-half">
						...
						<p>Preocupe-se apenas em curtir suas viagens com conforto e segurança do nosso transporte executivo! Levamos você para praias, hotéis fazenda, trilhas ecológicas, viagens fora do estado.</p>
					...
					<div class="qns-one-half qns-last">
						...
						<div class="photo-gallery-wrapper photo-gallery-1-col clearfix">
							...
							<div class="photo-gallery-item"><a href="images/viagens.jpg" data-gal="prettyPhoto"><img src="images/viagens.jpg" alt="" /></a></div>
