...
<!-- Title -->
	<title>Executive Car SP | Chauffeur Particular e Motorista Particular</title>
...
<body>
	...
	<div class="outer-wrapper">
		...
		<div id="page-header">
			<h1>Chauffeur Particular</h1>
			<div class="title-block3"></div>
			<p><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Chauffeur Particular</p>
		</div>
			...
			<div class="main-content main-content-full">
				...
				<div class="clearfix">
					...
					<div class="qns-one-half">
						...
						<h4>Chauffeur Particular</h4>
						<div class="title-block7"></div>
					
						<p>Caso você tenha veículo próprio e queira fazer uma viagem tranquila e sem cansaço, a 
<strong>Executive Car SP</strong> oferece serviço de Motorista Particular para pequenas ou grandes viagens, dentro do território nacional ou e até mesmo pela América do Sul.</p>
					...
					<div class="qns-one-half qns-last">
						...
						<div class="photo-gallery-wrapper photo-gallery-1-col clearfix">
							...
							<div class="photo-gallery-item"><a href="images/motorista-particular.jpg" data-gal="prettyPhoto"><img src="images/motorista-particular.jpg" alt="" /></a></div>
